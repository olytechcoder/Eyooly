...
import { Package, CheckCircle, Zap, TrendingUp, User } from "lucide-react";
...
export default function DispatchDashboard() {
  ...
  const menuItems = isSpanish
    ? [
        { icon: Package, label: "Solicitudes de entrega", href: "#", description: "Nuevas entregas" },
        { icon: CheckCircle, label: "Entregas asignadas", href: "#", description: "Mis entregas" },
    ...
    : [
        { icon: Package, label: "Delivery requests", href: "#", description: "New deliveries" },
        { icon: CheckCircle, label: "Assigned deliveries", href: "#", description: "My deliveries" },
  ...
  return (
    <div className="min-h-screen bg-cream pt-24 pb-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-carbon mb-2">{isSpanish ? "Panel Dispatch" : "Dispatch Dashboard"}</h1>
          <p className="text-carbon/60">{isSpanish ? "Gestiona tus entregas" : "Manage your deliveries"}</p>
        </div>
